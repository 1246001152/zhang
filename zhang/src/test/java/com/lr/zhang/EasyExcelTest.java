...
public class EasyExcelTest {
    ...
    public void simpleRead() {
        ...
        // 写法1：
        String fileName = "D:\\test\\car\\file\\text\\2021_05\\830d35f6-3011-4b44-80a8-8c63e308fe57.xlsx";
//         这里 需要指定读用哪个class去读，然后读取第一个sheet 文件流会自动关闭
        EasyExcel.read(fileName, ExpBudgetData.class, new ExpBudgetExcelDataListener()).sheet().headRowNumber(1).doRead();
